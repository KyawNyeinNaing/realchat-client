...
const ActiveIcon = ({ color, width, height }) => (
  <IconWrap width={width} height={height}>
    <GiPlainCircle color={color} />
  </IconWrap>
);

const WeChatIcon = ({ color, width, height }) => (
  <IconWrap width={width} height={height}>
    <FcAssistant color={color} />
  </IconWrap>
);
...
const ProfileIcon = ({ color, width, height }) => (
  <IconWrap width={width} height={height}>
    ...
    >
      ...
      />
      <path fill="#37474f" d="M29,31H19l-2,13h14L29,31z" />
      ...
      />
      <path fill="#37474f" d="M8,44h11V31C19,31,8,32.986,8,44z" />
      <path fill="#37474f" d="M29,31v13h11C40,33.025,29,31,29,31z" />
      <path fill="#37474f" d="M24,43l-0.001-0.002" />
      <path
        fill="#ffe082"
...
export { IoIosSend, ProfileIcon, ActiveIcon, WeChatIcon };
